...
<head>
	...
	echo "<br><br><big><table align='center' cellspacing='20'><tr><td><a href='A+Lung.php'><input type='button' value='A+' name='A+'></a></td>
	<td><a href='A-Lung.php'><input type='button' value='A-' name='A-'></a></td>
	<td><a href='B+Lung.php'><input type='button' value='B+' name='B+'></a></td>
	<td><a href='B-Lung.php'><input type='button' value='B-' name='B-'></a></td>
	<td><a href='AB+Lung.php'><input type='button' value='AB+' name='AB+'></a></td>
	<td><a href='AB-Lung.php'><input type='button' value='AB-' name='AB-'></a></td>
	<td><a href='O+Lung.php'><input type='button' value='O+' name='O+'></a></td>
	<td><a href='O-Lung.php'><input type='button' value='O-' name='O-'></a></td>
	<td><a href='OthersLung.php'><input type='button' value='Others' name='Others'></a></td>
	</tr></table></big>";
	$conn->close(); 
	?>
</head>
