...
<head>
	...
	echo "<br><br><big><table align='center' cellspacing='20'><tr><td><a href='A+Pancreas.php'><input type='button' value='A+' name='A+'></a></td>
	<td><a href='A-Pancreas.php'><input type='button' value='A-' name='A-'></a></td>
	<td><a href='B+Pancreas.php'><input type='button' value='B+' name='B+'></a></td>
	<td><a href='B-Pancreas.php'><input type='button' value='B-' name='B-'></a></td>
	<td><a href='AB+Pancreas.php'><input type='button' value='AB+' name='AB+'></a></td>
	<td><a href='AB-Pancreas.php'><input type='button' value='AB-' name='AB-'></a></td>
	<td><a href='O+Pancreas.php'><input type='button' value='O+' name='O+'></a></td>
	<td><a href='O-Pancreas.php'><input type='button' value='O-' name='O-'></a></td>
	<td><a href='OthersPancreas.php'><input type='button' value='Others' name='Others'></a></td>
	</tr></table></big>";
	$conn->close(); 
	?>
</head>
