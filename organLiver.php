...
<head>
	...
	echo "<br><br><big><table align='center' cellspacing='20'><tr><td><a href='A+Liver.php'><input type='button' value='A+' name='A+'></a></td>
	<td><a href='A-Liver.php'><input type='button' value='A-' name='A-'></a></td>
	<td><a href='B+Liver.php'><input type='button' value='B+' name='B+'></a></td>
	<td><a href='B-Liver.php'><input type='button' value='B-' name='B-'></a></td>
	<td><a href='AB+Liver.php'><input type='button' value='AB+' name='AB+'></a></td>
	<td><a href='AB-Liver.php'><input type='button' value='AB-' name='AB-'></a></td>
	<td><a href='O+Liver.php'><input type='button' value='O+' name='O+'></a></td>
	<td><a href='O-Liver.php'><input type='button' value='O-' name='O-'></a></td>
	<td><a href='OthersLiver.php'><input type='button' value='Others' name='Others'></a></td>
	</tr></table></big>";
	$conn->close(); 
	?>
</head>
